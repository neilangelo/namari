...
export class InMemoryDataService implements InMemoryDbService{
  ...
  createDb() {
    const users = [
      { id: 11, firstName: 'neil', lastName: 'berou', password: 'welcome', email: 'neilangelo1223@gmail.com' },
      { id: 12, firstName: 'neilme', lastName: 'berou', password: 'welcome', email: 'neilangelo1223@gmail.com' },
    ];
    return {users};
  }
